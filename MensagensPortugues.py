from MensagensInteracaoUsuario import MensagensInteracaoUsuario

#Resposta 1a - polimorfismo que implementa nos metodos com mesmos nomes os textos em portugues
...
class MensagensPortugues(MensagensInteracaoUsuario):
    ...
    # Resposta 1c: novo exemplo de polimorfismo (todas os metodos abaixo)
    # Radiobutton
    @property
